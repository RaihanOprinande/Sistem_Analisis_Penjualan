<div id="import-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="/transaction/import" class="p-4 md:p-5" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    {{-- <label for="file" class="block text-gray-700">Pilih File Excel (.xlsx)</label> --}}

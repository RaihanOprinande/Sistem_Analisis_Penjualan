<div id="crud-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="/komisi/store" method="POST">
                @csrf
                <input type="text" value="{{ $komisi->first()->id }}" name="platfrom_id" hidden>
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="tanggal_berlaku"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Effective Date</label>

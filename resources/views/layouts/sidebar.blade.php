        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-3xl whitespace-nowrap dark:text-white">Ayam
                        Taliwang Gandapura</span>
                </a>
                <div class="breadcrumb flex items-center justify-center">
                    @yield('breadcrumbs')
                </div>
            </div>
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                <form action="/logout" class="" method="POST">
                                    @csrf
                                    <button
                                        class="block px-4 py-2 w-full text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white text-left cursor-pointer"
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/platfrom"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Platfrom</span>
                    {{-- <span
            ...
            <li>
                <a href="/price"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Price Recomendation</span>
                </a>
            </li>
            <li>
                <a href="/transaction"
            ...
            <li>
                <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Analysis</span>
